	...
	'<div class="sewise-player-ui">' + 
		'<div class="controlbar">' + 
			...
			'<ul class="controlbar-btns">' + 
				...
				'<li class="right-float" style="width:37px;margin-top: 7px;margin-left:10px;margin-right:10px;">'+
					'<div class="clarity-switch-btn">' + 
						'<a style="text-indent:0;" href="javascript:;" class="clarity-btn-text" tabindex="1">默认</a>' + 
					'</div>' +
				'</li>'+ 
